...
def testImportTomsPrefsAll(): Unit = {
...
def testImportTomsPrefsPrompt(): Unit = {

  import TomsPrefs.prompt // imports prompt

}

def testImportTomsPrefsGiven(): Unit = {
...
def testImportTomsPrefsGivenPreferredDrink(): Unit = {
...
def testImportTomsPrefsGivenOrderingTypeParam(): Unit = {
...
def testImportTomsPrefsPrefPromptOrd(): Unit = {
